...
public:
	...
	void initializePop(Genome* genoA, Genome* genoB, string id, int rank, int size, int chromo_len, string fastaSeq, ofstream& opStream);
	...
	void doCrossoverWithAssociatedMemory(Genome *genoA, Genome *genoB, int start, int num_crossover, int chrom_len, string id, int rank, int size, int generations, string fastaSeq, ofstream& opStream);

	void fillRest(Genome *genoA, Genome *tempRet, int fill_rest_start_index, int start, int end, string id, int rank, int size, int generation, int chromo_len, string fastaSeq, ofstream& opStream);

	void doMutation(Genome *B, int start, int end, int chunk_width, string id, int rank, int size, int generation, int chromo_len, string fastaSeq, ofstream& opStream);

	void calcFitness(Genome &geno, string id, int rank, int generation, int chromo_index, int chromo_len, string fastaSeq, ofstream& opStream);
	void createPDBFromChromosome(Genome &geno, string id, int rank, int generation, int chromo_index, string fastaSeq, int chromo_len);
	void createPDBFromChromosomeAfterEachGeneration(Genome &geno, string id, int rank, int generations, int i, string fastaSeq, int chromo_len);
...
//	bool doMutationDuringInitilization(Genome &genoI, Genome &genoO, int mut_typ, int mut_ind, int chromo_len, int rank, int size, string fastaSeq);
	bool doMutationDuringInitilization(Genome &genoI, Genome &genoO, int chromo_len, int rank, int size, string fastaSeq, ofstream& opStream);
//	bool doMutationDuringInitialization(Genome &genoI, Genome &genoO, int chromo_len, int rank, int size, string fastaSeq);
	...
	bool checkAndCorrectSSAtCrossoverPoint(Genome &genoI, Genome &newTempGenome, vector<int> crossoverPositions1, string aa, int position, int chromo_len, string id, int rank, int generation, int chromo_index, int size, string fastaSeq, ofstream& opStream);
